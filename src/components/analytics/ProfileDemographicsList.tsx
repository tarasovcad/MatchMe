...
const ProfileDemographicsList = ({
  ...
  if (error) {
    return (
      <div className="w-full border border-border rounded-[12px] p-[18px]  @container relative max-h-[615px] flex flex-col">
  ...
  return (
    <div
      className={cn(
        "w-full border border-border rounded-[12px] p-[18px]  @container relative max-h-[615px] flex flex-col",
      ...
      {selectedDemographicList === "Map" ? (
        <div className="w-full mt-[18px] flex-1 relative">
          {isLoading ? (
            <div className="flex justify-center items-center h-full text-foreground/50 min-h-[487px]">
