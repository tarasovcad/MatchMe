...
export const GROUP_HEADING_CLASSES =
  "!px-0 pt-0 [&_[cmdk-group-heading]]:!text-secondary [&_[cmdk-group-heading]]:!font-medium [&_[cmdk-group-heading]]:text-sm [&_[cmdk-group-heading]]:px-3 [&_[cmdk-group-heading]]:pb-1 [&_[cmdk-group-heading]]:pt-2";
